...
CREATE TABLE employees (
	...
	CONSTRAINT employees_fk_regions FOREIGN KEY (region_id) REFERENCES regions (region_id) ON DELETE CASCADE,
...
INSERT INTO employees(employee_id,name,hire_date,salary,manager_id,region_id, department_id)
VALUES (8,'호로이','2012-08-17',1000,3,3,8);
INSERT INTO employees(employee_id,name,hire_date,salary,manager_id,region_id, department_id)
VALUES (9,'바라이','2014-03-02',4500,4,4,8);
INSERT INTO employees(employee_id,name,hire_date,salary,manager_id,region_id, department_id)
 ...
 */
 ...
 /*
    ...
    부서별 직원 조회
*/
SELECT E.*, R.region_name, D.department_title
